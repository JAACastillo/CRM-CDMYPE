...
@section('content')
    ...
    <!-- Start Page Banner -->
    <div class="page-banner" style="padding:40px 0; background: url(page/images/slide-02-bg.jpg) center #f9f9f9;">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <h2>About Us</h2>
          ...
          <div class="row">
            ...
            <div class="col-md-5">
              ...
              <div class="touch-slider" data-slider-navigation="true" data-slider-pagination="true">
                <div class="item"><img alt="" src="page/images/about-01.jpg"></div>
                <div class="item"><img alt="" src="page/images/about-02.jpg"></div>
                <div class="item"><img alt="" src="page/images/about-03.jpg"></div>
              </div>
              <!-- End Touch Slider -->
          ...
          <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="team-member">
                ...
                <div class="member-photo">
                  <img alt="" src="page/images/team/face_1.png" />
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="team-member">
                <!-- Memebr Photo, Name & Position -->
                <div class="member-photo">
                  <img alt="" src="page/images/team/face_2.png" />
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="team-member">
                <!-- Memebr Photo, Name & Position -->
                <div class="member-photo">
                  <img alt="" src="page/images/team/face_3.png" />
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="team-member">
                <!-- Memebr Photo, Name & Position -->
                <div class="member-photo">
                  <img alt="" src="page/images/team/face_4.png" />
