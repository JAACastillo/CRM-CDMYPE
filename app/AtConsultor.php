...
class AtConsultor extends Model {
    ...
    /* RELACIÓN */
        ...
        {
            return $this->hasmany('App\AtContrato','atconsultor_id');
        }

        public function ampliacionesContratos() 
        {
            return $this->hasmany('App\AmpliacionContrato','atconsultor_id');
        }

        public function actas() 
        {
            return $this->hasmany('App\Acta','atconsultor_id');
        }
