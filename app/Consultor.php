...
class Consultor extends Model {
    ...
    /* Relaciones */
        ...
        {
            return $this->hasMany('App\CapConsultor', 'consultor_id');
        }

        public function atConsultores() 
        {
            return $this->hasMany('App\AtConsultor', 'consultor_id');
        }

        public function especialidades() 
        {
            return $this->hasMany('App\ConsultorEspecialidad', 'consultor_id');
        }
