...
class CapTermino extends Model {
    ...
    /* Relaciones */
        ...
        {
            $consultor = $this->hasOne('App\CapConsultor','captermino_id')->where('estado', '=', 'Seleccionado');

            return $consultor;
        }

        public function contrato(){
            return $this->hasOne('App\CapContrato', 'captermino_id');
        }

        public function asistencia(){
            return $this->hasOne('App\Asistencia', 'captermino_id');
        }

        public function envios(){
            return $this->hasMany('App\CapacitacionEnvios', 'capacitacion_id');
        }
